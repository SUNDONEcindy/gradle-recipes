...
load("//tools/base/build-system/integration-test:common-dependencies.bzl", "BUILT_IN_KOTLIN_VERSION", "KGP_1_8_10", "KGP_1_9_22", "KGP_2_1_20", "KGP_2_3_10")
...
maven_repository(
    name = "test_deps",
    artifacts = [
        "@maven//:org.jetbrains.kotlin.kotlin-test-junit_" + BUILT_IN_KOTLIN_VERSION,
    ],
