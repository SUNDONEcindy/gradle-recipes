...
* Artifact API - [addMultipleArtifact](addMultipleArtifact), [transformDirectory](transformDirectory), [createSingleArtifact](createSingleArtifact), [getSingleArtifact](getSingleArtifact), [workerEnabledTransformation](workerEnabledTransformation), [getScopedArtifacts](getScopedArtifacts), [transformAllClasses](transformAllClasses), [appendToScopedArtifacts](appendToScopedArtifacts), [appendToMultipleArtifact](appendToMultipleArtifact), [transformManifest](transformManifest), [getMultipleArtifact](getMultipleArtifact)
...
* Artifacts.use() - [transformDirectory](transformDirectory), [createSingleArtifact](createSingleArtifact), [workerEnabledTransformation](workerEnabledTransformation), [appendToMultipleArtifact](appendToMultipleArtifact), [transformManifest](transformManifest)
