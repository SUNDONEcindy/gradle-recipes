...
* Artifacts.use() - [transformManifest](transformManifest), [listenToArtifacts](listenToArtifacts), [createSingleArtifact](createSingleArtifact), [workerEnabledTransformation](workerEnabledTransformation), [transformDirectory](transformDirectory), [appendToMultipleArtifact](appendToMultipleArtifact)
